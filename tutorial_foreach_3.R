# Tutorial 3: High Performance Data Analytics with R (package: foreach)
...
# This example uses 4 cores.

# To execute this file:
# $ qsub pbs_test_parallel_3
...
sink("tutorial_foreach_3.result") # Redirect console output to the named file
summaries
